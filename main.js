...
class Popover {
  constructor(element) {
    ...
    this._message = ["Здесь могла бы быть ваша реклама!", "Улыбочку!", "Завтра у вас будет удачный день!", "Минус 50 000 рублей на вашей карте!", "Попробуй еще раз!"];
  ...
  showPopover(e) {
    ...
    popoverElement.style.left = `${left + this.element.offsetWidth / 2 - popoverElement.offsetWidth / 2}px`;
